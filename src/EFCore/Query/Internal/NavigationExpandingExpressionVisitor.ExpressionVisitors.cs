    ...
    public partial class NavigationExpandingExpressionVisitor
    {
        ...
        private class ExpandingExpressionVisitor : ExpressionVisitor
        {
                ...
                Expression root, EntityReference entityReference, ISkipNavigation navigation, bool derivedTypeConversion)
            {
                    ...
                    || navigation.IsOnDependent)
                {
                    ...
                    secondaryExpansion = ExpandForeignKey(
                        ...
                        !inverseNavigation.IsOnDependent, derivedTypeConversion: false, includeTree);
                }
                else
                {
                        ...
                        || !inverseNavigation.IsOnDependent)
                    {
                        ...
                        var outerKey = outerKeyparameter.CreateKeyValueReadExpression(
                                !inverseNavigation.IsOnDependent
                        ...
                        var innerKey = innerKeyParameter.CreateKeyValueReadExpression(
                                !inverseNavigation.IsOnDependent
                                    ? secondaryForeignKey.PrincipalKey.Properties
                                    : secondaryForeignKey.Properties,
                                makeNullable: true);
                    ...
                    else
                    {
                        ...
                        var outerKey = outersourceParameter.CreateKeyValueReadExpression(
                                !inverseNavigation.IsOnDependent
                                    ? secondaryForeignKey.Properties
                                    : secondaryForeignKey.PrincipalKey.Properties,
                                makeNullable: true);
                        ...
                        var innerKey = innerSourceParameter.CreateKeyValueReadExpression(
                                !inverseNavigation.IsOnDependent
                                    ? secondaryForeignKey.PrincipalKey.Properties
                                    : secondaryForeignKey.Properties,
                                makeNullable: true);
            ...
            private Expression ExpandForeignKey(
                ...
                IncludeTreeNode additionalIncludeTree = null)
            {
                ...
                if (targetType.HasDefiningNavigation()
                    || targetType.IsOwned())
                {
                    throw new InvalidOperationException("Expanding foreign key to owned/weak entity type is not supported.");
                }
                ...
                if (additionalIncludeTree != null)
                {
                    innerEntityReference.IncludePaths.Merge(additionalIncludeTree);
                }
