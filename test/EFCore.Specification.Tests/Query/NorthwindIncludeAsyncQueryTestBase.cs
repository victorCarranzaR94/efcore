...
{
    public abstract class NorthwindIncludeAsyncQueryTestBase<TFixture> : IClassFixture<TFixture>
        where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
    {
        protected NorthwindIncludeAsyncQueryTestBase(TFixture fixture) => Fixture = fixture;
